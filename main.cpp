/*  T02: Collaboration Teamwork
    ...
    TODO: <Zak Shendera> -- to be added by student 1
...
int main() {
    ...
    for (int i = 0; i < ducknum; i++) { 
        cout << "                -__-__-__- __     " << endl; // TODO: student 1 may change this line and may add additional lines immediately above
        cout << "              <(o )___-" << endl; // student 3(1) may change this line and add additional lines between this line and immediately below
        cout << "               ( .__> /" << endl; // Not changing anything
        cout << "                `----' " << endl; // Not changing anything
        cout << " ~~~~~~~~~~~~~~~~~~~~~~" << endl; // Added water
        cout << "                 |  |  " << endl; // Added legs
        cout << "                 <  <  " << endl; // Added Feet
    }
